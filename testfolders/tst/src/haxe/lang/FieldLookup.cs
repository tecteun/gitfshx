...
namespace haxe.lang {
	public sealed class FieldLookup {
		...
		protected static int[] fieldIds = new int[]{105, 109, 4745537, 4849249, 5393365, 5442204, 5594513, 76061764, 87367608, 302979532, 328878574, 359333139, 407283053, 452737314, 501039929, 520590566, 922671056, 937215358, 946786476, 995006396, 1067353468, 1103412149, 1181037546, 1204816148, 1224901875, 1247875546, 1259313084, 1280845662, 1282943179, 1313416818, 1352786672, 1395555037, 1532710347, 1537812987, 1547539107, 1620824029, 1621420777, 1623148745, 1648581351, 1705629508, 1781145963, 1830310359, 1915412854, 1916009602, 1920680176, 1981972957, 2025055113, 2048392659, 2082663554, 2084789794, 2127021138};
		
		protected static string[] fields = new string[]{"i", "m", "__a", "arr", "len", "map", "pop", "remove", "filter", "methodName", "iterator", "lastIndexOf", "hasNext", "reverse", "insert", "length", "cachedIndex", "Tree", "toString", "hashes", "splice", "copy", "join", "concat", "next", "push", "Leaves", "sort", "quicksort", "vals", "spliceVoid", "cachedKey", "concatNative", "nBuckets", "className", "__unsafe_get", "__unsafe_set", "indexOf", "fileName", "toDynamic", "__hx_constructs", "customParams", "__get", "__set", "CurrentCommit", "lineNumber", "unshift", "_keys", "shift", "__hx_createEmpty", "slice"};
